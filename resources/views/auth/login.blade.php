...
<head>
    ...
    <title>Sign In | Parking Management System</title>
        ...
        <div class="container-fluid h-100">
            <div class="row flex-row h-100 bg-white">
                <div class="col-xl-8 col-lg-6 col-md-5 p-0 d-md-block d-lg-block d-sm-none d-none">
                    <div class="lavalite-bg" style="background-image: url('img/iict.png')">
                ...
                <div class="col-xl-4 col-lg-6 col-md-7 my-auto p-0">
                    <div class="authentication-form mx-auto">
                        <div class="logo-centered">
                            <img style="max-height: 150px;" src="{{ asset('img/logo.png') }}" alt="">
                        </div>
                        <h3>Sign In</h3>
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" value="{{ old('email', 'admin@mail.com') }}" required autocomplete="email" placeholder="email" autofocus>
                            ...
                            <div class="form-group">
                                <input id="password" type="password"
                                    ...
                                    required autocomplete="current-password" placeholder="password" value="12345678">
